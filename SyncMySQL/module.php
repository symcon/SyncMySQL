...
class SyncMySQL extends IPSModule
{
    ...
    //https://regex101.com/r/GgABOy/3
    private $identFormats = [
        '', //Custom
        "^([A-Za-z0-9]+)-([_A-Za-z0-9]+)-([A-Z0-9]+)-([A-Za-z0-9]+)=([0-9]+)\+([A-Za-z0-9]+)-([A-Za-z0-9]+)-([0-9]+)([A-Z])([0-9]+)\/([A-Z]+)-([_A-Za-z0-9]+)-([_A-Za-z0-9]+)-([_A-Za-z0-9]*)-([_A-Za-z0-9]*)-([_A-Za-z0-9]*)-([_A-Za-z0-9]*)-([_A-Za-z0-9]*)$"
    ];
